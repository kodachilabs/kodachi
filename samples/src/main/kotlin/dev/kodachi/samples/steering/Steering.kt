package dev.kodachi.samples.steering
 ...
 * so the work already done is kept. Use [dev.kodachi.TurnHandle.interrupt] to stop instead.
 *
 * ```
 * ./gradlew :samples:run -Psample=dev.kodachi.samples.SteeringKt
 * ```
 */
