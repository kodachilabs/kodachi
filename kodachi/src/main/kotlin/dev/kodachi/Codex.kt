...
import dev.kodachi.internal.CodexJson
import dev.kodachi.protocol.AccountApi
import dev.kodachi.protocol.AppsApi
import dev.kodachi.protocol.ClientInfo
...
import dev.kodachi.protocol.CommandApi
import dev.kodachi.protocol.ConfigApi
import dev.kodachi.protocol.ConfigRequirementsApi
import dev.kodachi.protocol.ExperimentalFeatureApi
import dev.kodachi.protocol.ExternalAgentConfigApi
import dev.kodachi.protocol.FeedbackApi
import dev.kodachi.protocol.FsApi
import dev.kodachi.protocol.FuzzyFileSearchApi
import dev.kodachi.protocol.HooksApi
import dev.kodachi.protocol.InitializeCapabilities
import dev.kodachi.protocol.InitializeParams
import dev.kodachi.protocol.InitializeResponse
import dev.kodachi.protocol.MarketplaceApi
import dev.kodachi.protocol.McpServerApi
import dev.kodachi.protocol.McpServerStatusApi
import dev.kodachi.protocol.ModelApi
import dev.kodachi.protocol.ModelListParams
import dev.kodachi.protocol.ModelListResponse
import dev.kodachi.protocol.ModelProviderApi
import dev.kodachi.protocol.PermissionProfileApi
import dev.kodachi.protocol.Personality
import dev.kodachi.protocol.PluginsApi
import dev.kodachi.protocol.ProtocolCaller
import dev.kodachi.protocol.ReviewApi
import dev.kodachi.protocol.SkillsApi
import dev.kodachi.protocol.ThreadForkParams
import dev.kodachi.protocol.ThreadForkResponse
import dev.kodachi.protocol.ThreadListParams
import dev.kodachi.protocol.ThreadListResponse
import dev.kodachi.protocol.ThreadResumeParams
import dev.kodachi.protocol.ThreadResumeResponse
import dev.kodachi.protocol.ThreadStartParams
import dev.kodachi.protocol.ThreadStartResponse
import dev.kodachi.protocol.ThreadsApi
import dev.kodachi.protocol.TurnsApi
import dev.kodachi.protocol.WindowsSandboxApi
...
public class Codex(
     ...
     * [dev.kodachi.protocol.ClientRequests] holds every method name this protocol
     * version defines.
     */
